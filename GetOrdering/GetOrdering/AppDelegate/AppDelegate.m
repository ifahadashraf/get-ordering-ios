...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if (!locAccuracy) {
        [[NSUserDefaults standardUserDefaults]setBool:YES forKey:@"isLocUpdates"];
    ...
    GOHomeViewController *rootViewController = [storyboard instantiateViewControllerWithIdentifier:@"GOHomeViewController"];
    GOMenuViewController *rearNavigationController = [storyboard instantiateViewControllerWithIdentifier:@"GOMenuViewController"];
